...
| [aws_iam_policy.nodes_volume_create](https://registry.terraform.io/providers/aws/latest/docs/resources/iam_policy) | resource |
...
| [aws_iam_policy_attachment.nodes_volume_create](https://registry.terraform.io/providers/aws/latest/docs/resources/iam_policy_attachment) | resource |
...
| [aws_iam_policy_document.nodes_volume_create](https://registry.terraform.io/providers/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
|------|-------------|------|---------|:--------:|
| <a name="input_addon_cni_version"></a> [addon\_cni\_version](#input\_addon\_cni\_version) | VPC CNI Version | `string` | n/a | yes |
...
| <a name="input_karpenter_azs"></a> [karpenter\_azs](#input\_karpenter\_azs) | n/a | `list` | n/a | yes |
| <a name="input_karpenter_capacity_type"></a> [karpenter\_capacity\_type](#input\_karpenter\_capacity\_type) | n/a | `list` | n/a | yes |
| <a name="input_karpenter_instance_class"></a> [karpenter\_instance\_class](#input\_karpenter\_instance\_class) | n/a | `list` | n/a | yes |
| <a name="input_karpenter_instance_size"></a> [karpenter\_instance\_size](#input\_karpenter\_instance\_size) | n/a | `list` | n/a | yes |
